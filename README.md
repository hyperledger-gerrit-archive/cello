...
## Quick Start
Environment prepare, before launch cello service, need install docker [how install](https://get.docker.com), docker-compose [how install](https://docs.docker.com/compose/install/),
make (because all script for cello service management is written in Makefile), kubernetes (optional) [how install](https://kubernetes.io/docs/setup/).
