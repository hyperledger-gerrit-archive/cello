...
servers such as virtaul machines in your cloud, or physical or virtual
...
5. [Create configuration files](#create-configuration-files)
6. [Provision the servers](#provision-the-servers)
7. [Initialize the servers](#initialize-the-servers)
8. [Setup fabric network](#setup-fabric-network)
9. [Verify fabric network](#verify-fabric-network)
...
Please follow offical ansible installation instructions from ansible web
site to install ansible. If you like to start quickly and have a clean
Ubuntu 16.04 system, here are the commands to install ansible::
...
The results should show something at or above 2.3.0.0.
...
[Cloud configuration file details](#cloud-configuration-file-details)
