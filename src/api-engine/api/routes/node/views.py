...
from api.common.enums import NodeStatus, FabricNodeType, AgentOperation
...
class NodeViewSet(viewsets.ViewSet):
    ...
    @action(detail=False)
    def list_peer(self, request, *args, **kwargs):
        """
        List Peers
    ...
    def operate_peer(self, request, pk=None):
        """
        Operate Peer
    ...
    def destroy_peer(self, request, pk=None):
        """
        Delete Peer
    ...
    @action(detail=True)
    def retrieve_peer(self, request, pk=None):
        """
        Get Node information
