...
class ClusterHandler(object):
    ...
    def gen_ports_mapping(self, peer_num, ca_num, start_port, host_id):
        ...
        mapped_ports.update(peer_ports)
        mapped_ports.update(ca_ports)
        mapped_ports.update(orderer_ports)
        mapped_ports.update(explorer_ports)

        return mapped_ports, peer_ports, ca_ports, orderer_ports, \
               explorer_ports
