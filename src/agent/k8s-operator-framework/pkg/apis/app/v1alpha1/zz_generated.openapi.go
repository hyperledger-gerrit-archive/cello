	...
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
					...
					"volumes": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("cello/cello-k8s-fabric-operator/pkg/apis/app/v1alpha1.CaVolumes"),
									},
								},
							},
						},
				...
				Required: []string{"metadata", "replicas", "restartPolicy", "containers", "volumes"},
			},
		},
		Dependencies: []string{
			"cello/cello-k8s-fabric-operator/pkg/apis/app/v1alpha1.CAContainers", "cello/cello-k8s-fabric-operator/pkg/apis/app/v1alpha1.CAMetadata", "cello/cello-k8s-fabric-operator/pkg/apis/app/v1alpha1.CaVolumes"},
	}
}
