...
type CAsSpec struct {
	...
	Volumes []*CaVolumes `json:"volumes"`
}

type CaVolumes struct {
	Name     string `json:"name"`
	PersistentVolumeClaim *CAsPersistentVolumeClaims `json:"persistentVolumeClaim"`
}

type CAsPersistentVolumeClaims struct {
...
type CAContainers struct {
	...
	VolumeMounts    []*CAVolumeMounts `json:"volumeMounts"`
	Env []*CAEnv `json:"env"`
}

type CAVolumeMounts struct {
