	...
	if !ok {
		...
		if secret != nil {
			...
			if value != "" && value == "true" && cr.Spec.Certs.TLSCerts != nil {
				...
				containerEnvs = append(containerEnvs,
					corev1.EnvVar{Name: "CORE_PEER_TLS_CERT_FILE", Value: "/certs/tls/tlsCert"},
					corev1.EnvVar{Name: "CORE_PEER_TLS_KEY_FILE", Value: "/certs/tls/tlsKey"},
					corev1.EnvVar{Name: "CORE_PEER_TLS_ROOTCERT_FILE", Value: "/certs/tls/tlsRootcert"},
				)
			}
