...
class VsphereOperation():
    ...
    def pull_images(self, worker_api):
        ...
        try:
            ...
            self.pull_and_tag_fabric_explorer_images(client)
            return True
    ...
    def pull_and_tag_fabric_explorer_images(self, docker_client):
        """
        ...
        """
        try:
            image = utils.FABRIC_EXPLORER_IMAGE
            tag = utils.FABRIC_EXPLORER_TAG
